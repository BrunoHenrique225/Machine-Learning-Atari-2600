...
parser.add_argument('--env-name',default="boxing",type=str,choices=["pong","breakout","boxing"], help="env name")
parser.add_argument('--model', default="dqn", type=str, choices=["dqn","dueldqn"], help="dqn model")
parser.add_argument('--gpu',default=0,type=int,help="which gpu to use") # Valor padrão: 0
parser.add_argument('--lr', default=2.5e-4, type=float, help="learning rate")
parser.add_argument('--epoch', default=880, type=int, help="training epoch") # Define a quantidade de épochs - padrão 10001
parser.add_argument('--batch-size', default=32, type=int, help="batch size")
parser.add_argument('--ddqn',action='store_true', help="double dqn/dueldqn")
parser.add_argument('--eval-cycle', default=125, type=int, help="evaluation cycle") # Valor padrão: 500
args = parser.parse_args()
print(args.ddqn)
args.ddqn = True
print(args.ddqn)
print(f"Episódios totais: {args.epoch}")
...
print(f"Caminho do diretório: {log_dir}")
